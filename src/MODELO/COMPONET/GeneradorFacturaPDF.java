...
public class GeneradorFacturaPDF {
    ...
    public void generarPDF(String codigoFactura, String empleado, String cliente, String emailCliente, DefaultTableModel modelo, String fecha) {
        try {
            ...
            if (direccionDescarga != null) {
                ...
                header.setInvoiceTitle("LADYSHOP");
                ...
                addressDetails.setShippingAddress("Direccion");
                addressDetails.setShippingAddressText("Direccion");
                addressDetails
                ...
                List<Product> listaProductos = getProductos(modelo);
    ...
    private List<Product> getProductos(DefaultTableModel modeloTabla) {
