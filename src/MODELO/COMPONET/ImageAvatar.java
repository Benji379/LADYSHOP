...
public class ImageAvatar extends JComponent {
    ...
    protected void paintComponent(Graphics grphcs) {
        ...
        if (image != null) {
            ...
            g2_img.fill(new RoundRectangle2D.Double(0, 0, diameter, diameter, borderRadius, borderRadius));
    ...
    private void createBorder(Graphics2D g2) {
        ...
        if (isOpaque()) {
            ...
            g2.fill(new RoundRectangle2D.Double(x, y, diameter, diameter, borderRadius, borderRadius));
        }
        Area area = new Area(new RoundRectangle2D.Double(x, y, diameter, diameter, borderRadius, borderRadius));
        int s = diameter -= (borderSize * 2);
        area.subtract(new Area(new RoundRectangle2D.Double(x + borderSize, y + borderSize, s, s, borderRadius, borderRadius)));
